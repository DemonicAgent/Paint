...
title = display.set_caption("Saad's Paint - Where Microsoft got the idea =P")


canvas = Rect(102, 52, 696, 526) # main canvas
bcanvas = Rect (100, 50, 700, 530) # border around canvas 
running = True
...
def save():
        global subc
        filename = raw_input("enter the name you would like to save as (do not include extension)")
        image.save(subc, ("saved/" + filename + ".jpg"))
        print "file saved!"
